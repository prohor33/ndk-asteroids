...
void Java_prohor33_ndk_asteroids_DemoGLSurfaceView_nativeUp(JNIEnv*  env, jobject  thiz, jfloat x, jfloat y) {
    appUp(x, y);
}

/* Call to render the next GL frame */
void Java_prohor33_ndk_asteroids_DemoRenderer_nativeRender(JNIEnv*  env) {
    long curTime;
